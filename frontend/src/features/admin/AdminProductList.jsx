...
import { fetchBrandsAsync, fetchCategoriesAsync, fetchProductByFilterAsync } from '../product/productSlice';
...
export default function AdminProductList() {
  ...
  const {products,brands,categories,totalItems} = useSelector((state) => state.products);
