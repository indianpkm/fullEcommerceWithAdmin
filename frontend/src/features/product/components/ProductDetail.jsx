...
//   images: [
//     {
//       src: 'https://tailwindui.com/img/ecommerce-images/products-page-02-secondary-products-shot.jpg',
//       alt: 'Two each of gray, white, and black shirts laying flat.',
//     },
//     {
//       src: 'https://tailwindui.com/img/ecommerce-images/products-page-02-tertiary-products-shot-01.jpg',
//       alt: 'Model wearing plain black basic tee.',
//     },
//     {
//       src: 'https://tailwindui.com/img/ecommerce-images/products-page-02-tertiary-products-shot-02.jpg',
//       alt: 'Model wearing plain gray basic tee.',
//     },
//     {
//       src: 'https://tailwindui.com/img/ecommerce-images/products-page-02-featured-products-shot.jpg',
...
export default function ProductDetail() {
  ...
  const handleCart = (e) => {
    e.preventDefault();
    if(items.findIndex(item=>item.product.id===products.id)<0){
      const newItem={
        product:products.id,
        quantity:1,
        user:user.id
